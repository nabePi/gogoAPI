...
func OrderDetailHandler(w http.ResponseWriter, r *http.Request, ctx *co.AppContext) {

	var (
		lr ds.OrderDetailResponse
	)
	...
	if ctx.Status == "success" {
		...
		if r.Body != nil {
			...
			if err := json.Unmarshal(buf.Bytes(), &res); err != nil {
				...
				ds.GetOrderDetail(ctx.Db, &res, &lr)
				//fmt.Println(res)
